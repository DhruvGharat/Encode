...
const MMSETest = () => {
  ...
  if (isFinished) {
    const score = calculateScore(answers, mmseQuestions);
    const result = interpretMMSE(score);
        ...
        <div className="card-modern results-summary-v2">
          ...
          <div className="score-viz-v2">
            ...
            <div className="result-badge-v2" style={{ background: `${result.color}15`, color: result.color }}>
              <TrendingUp size={24} />
              <div>
                <h3>{result.level} Classification</h3>
    ...
    <div className="test-player-v2 container animate-fade-up">
      ...
      <div className="player-body-v2">
        ...
        <div className="player-nav-v2">
          ...
          <button
            className="btn-text-v2"
            onClick={() => setCurrentStep(Math.min(mmseQuestions.length - 1, currentStep + 1))}
          >
      ...
      <style jsx>{`
        ...
        .opt-tile-v2:hover { border-color: var(--primary); background: var(--surface-alt); }
        .opt-tile-v2.selected { border-color: var(--primary); background: #f0f7ff; box-shadow: 0 4px 12px rgba(74, 144, 226, 0.1); }
        .opt-indicator { 
        ...
        .opt-tile-v2.selected .opt-indicator { background: var(--primary); color: white; }
