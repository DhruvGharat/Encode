...
const Navbar = () => {
  ...
  // For internal pages, we want a clean header. For landing, a more marketing focused one.
  return (
    <nav className={`nav-v2 ${!isLandingPage ? 'nav-clinical' : ''}`}>
      ...
      <style jsx>{`
        ...
        .btn-v2-primary { 
          text-decoration: none; background: var(--grad-primary); color: white; padding: 10px 24px; border-radius: 12px; font-weight: 700; font-size: 0.95rem; 
