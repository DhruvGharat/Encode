...
import { Activity, LayoutDashboard, ClipboardCheck, Mic, Upload, FileText, UserRound, LogOut, ChevronRight } from 'lucide-react';
  ...
  return (
    <aside className="sidebar-enhanced">
      ...
      <div className="sidebar-foot">
        ...
        <div className="user-profile-mini">
          ...
          <div className="u-info">
            ...
            <span>{user?.patient_id || 'Patient Account'}</span>
          </div>
        </div>
      </div>
      ...
      <style jsx>{`
        ...
        .user-profile-mini { margin-top: 16px; padding: 16px; background: var(--background); border-radius: 16px; display: flex; align-items: center; gap: 12px; }
